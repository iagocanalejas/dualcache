package es.coru.iagocanalejas.dualcache;
...
import es.coru.iagocanalejas.library.DualCache;
...
public class DemoActivity extends Activity {
    ...
    //CHECKSTYLE:OFF
    @BindView(R.id.buttonAddObjectAToCache)
    protected Button mButtonAddObjectA;
    @BindView(R.id.buttonAddObjectBToCache)
    protected Button mButtonAddObjectB;
    @BindView(R.id.buttonAddRandomObjectToCache)
    protected Button mButtonAddRandomObject;
    @BindView(R.id.buttonDisplayObjectB)
    protected Button mButtonDisplayObjectB;
    @BindView(R.id.buttonDisplayObjectA)
    protected Button mButtonDisplayObjectA;
    @BindView(R.id.buttonDisplayRandomObject)
    protected Button mButtonDisplayRandomObject;
    @BindView(R.id.buttonInvalidateCache)
    protected Button mButtonInvalidateCache;
    @BindView(R.id.textViewDataSizeRam)
    protected TextView mTextViewDataRam;
    @BindView(R.id.textViewDataSizeDisk)
    protected TextView mTextViewDataDisk;
    @BindView(R.id.textViewDataTime)
    protected TextView mTextViewDataTime;
    //CHECKSTYLE:ON
