...
public class SettingsActivity extends Activity {
    ...
    //CHECKSTYLE:OFF
    @BindView(R.id.activity_settings_edittext_ram_cache_size)
    protected EditText mEditTextSizeRam;
    @BindView(R.id.activity_settings_edittext_disk_cache_size)
    protected EditText mEditTextSizeDisk;
    @BindView(R.id.activity_settings_edittext_cache_id)
    protected EditText mEditTextIdCache;
    @BindView(R.id.activity_settings_button_demo)
    protected Button mButtonDemo;
    //CHECKSTYLE:ON
